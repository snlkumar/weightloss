class FlashFilesController < ApplicationController
  # GET /flash_files
  # GET /flash_files.xml
  def index
    @flash_files = FlashFile.all
  ...
  def show
    @flash_file = FlashFile.find(params[:id])
  ...
  def create
    @flash_file = FlashFile.new(params[:flash_file])
  ...
  def update
    ...
    respond_to do |format|
      if @flash_file.update_attributes(params[:flash_file])
