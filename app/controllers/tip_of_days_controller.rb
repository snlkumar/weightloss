class TipOfDaysController < ApplicationController
  # GET /tip_of_days
  # GET /tip_of_days.xml
  def index
    @tip_of_days = TipOfDay.all
  ...
  def show
    @tip_of_day = TipOfDay.find(params[:id])
  ...
  def create
    @tip_of_day = TipOfDay.new(params[:tip_of_day])
  ...
  def update
    ...
    respond_to do |format|
      if @tip_of_day.update_attributes(params[:tip_of_day])
