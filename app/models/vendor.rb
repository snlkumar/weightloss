...
has_attached_file :photo,
  ...
  validates_presence_of :business_name, :email, :password, :if => :business?  
  validates_presence_of :city, :state, :zipcode, :country, :contact1,:presence=>true, :on => [:create], :if => :profile? 
